...
describe("Profession Patch Preservation Suite", () => {
  // DEFAULT-SOURCE PHANTOM-TAG REGRESSION TEST (Pure NBT Roundtrip)
  ...
  // TRADE-EDIT VERSION OF THE TEST
  ...
  // TradesInferred PRESERVATION TEST
  ...
  // WorkstationBlock PRESERVATION TEST
  ...
  // EXPLICIT PROFESSION CHANGE FROM DEFAULT SOURCE TEST
